...
public class WritersUserController {
  ...
  public WritersUser add(@Valid @RequestBody WritersUserBuilder user)
  ...
  public WritersUser getByUserId(@PathVariable Long id)
    ...
    WritersUser idUser = user.get();

    if (!loggedInUsername.equals(idUser.getUsername())) {
  ...
  @ResponseBody
  @ResponseStatus(HttpStatus.OK)
  public WritersUser update(@PathVariable Long id, @Valid @RequestBody WritersUserBuilder user)
